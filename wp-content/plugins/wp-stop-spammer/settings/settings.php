...
function ss_admin_menu_l() {
	...
	add_submenu_page(
		...
		__( 'Summary — Stop Spammers', 'wp-stop-spammer' ), // $page_title,
		__( 'Summary', 'wp-stop-spammer' ), // $menu_title,
		'manage_options', // $capability,
		'stop_spammers', // $menu_slug,
		'ss_summary' // $function
	);
	if ( !is_plugin_active( 'stop-spammers-premium/stop-spammers-premium.php' ) ) {
		add_submenu_page(
			'stop_spammers', // plugins parent
			__( 'Premium — Stop Spammers', 'wp-stop-spammer' ), // $page_title,
			__( '<span class="gopro">Premium Security</span>', 'wp-stop-spammer' ), // $menu_title,
			'manage_options', // $capability,
	...
	add_submenu_page(
		'stop_spammers', // plugins parent
		__( 'Protection Options — Stop Spammers', 'wp-stop-spammer' ), // $page_title,
		__( 'Protection Options', 'wp-stop-spammer' ), // $menu_title,
		'manage_options', // $capability,
	...
	add_submenu_page(
		'stop_spammers', // plugins parent
		__( 'Allow Lists — Stop Spammers', 'wp-stop-spammer' ), // $page_title,
		__( 'Allow Lists', 'wp-stop-spammer' ), // $menu_title,
		'manage_options', // $capability,
	...
	add_submenu_page(
		'stop_spammers', // plugins parent
		__( 'Block Lists — Stop Spammers', 'wp-stop-spammer' ), // $page_title,
		__( 'Block Lists', 'wp-stop-spammer' ), // $menu_title,
		'manage_options', // $capability,
	...
	add_submenu_page(
		'stop_spammers', // plugins parent
		__( 'Challenge & Block — Stop Spammers', 'wp-stop-spammer' ), // $page_title,
		__( 'Challenge & Block', 'wp-stop-spammer' ), // $menu_title,
		'manage_options', // $capability,
	...
	add_submenu_page(
		'stop_spammers', // plugins parent
		__( 'Web Services — Stop Spammers', 'wp-stop-spammer' ), // $page_title,
		__( 'Web Services', 'wp-stop-spammer' ), // $menu_title,
		'manage_options', // $capability,
	...
	add_submenu_page(
		'stop_spammers', // plugins parent
		__( 'Cache — Stop Spammers', 'wp-stop-spammer' ), // $page_title,
		__( 'Cache', 'wp-stop-spammer' ), // $menu_title,
		'manage_options', // $capability,
		'ss_cache', // $menu_slug,
		'ss_cache' // function
	);
	add_submenu_page(
		'stop_spammers', // plugins parent
		__( 'Log Report — Stop Spammers', 'wp-stop-spammer' ), // $page_title,
		__( 'Log Report', 'wp-stop-spammer' ), // $menu_title,
		'manage_options', // $capability,
	...
	add_submenu_page(
		'stop_spammers', // plugins parent
		__( 'Diagnostics — Stop Spammers', 'wp-stop-spammer' ), // $page_title,
		__( 'Diagnostics', 'wp-stop-spammer' ), // $menu_title,
		'manage_options', // $capability,
	...
	add_submenu_page(
		'stop_spammers', // plugins parent
		__( 'Beta: DB Cleanup — Stop Spammers', 'wp-stop-spammer' ), // $page_title,
		__( 'Beta: DB Cleanup', 'wp-stop-spammer' ), // $menu_title,
		'manage_options', // $capability,
	...
	if ( function_exists( 'is_multisite' ) && is_multisite() ) {
		add_submenu_page(
			'stop_spammers', // plugins parent
			__( 'Multisite — Stop Spammers', 'wp-stop-spammer' ), // $page_title,
			__( 'Network', 'wp-stop-spammer' ), // $menu_title,
			'manage_options', // $capability,
...
function include_setting( $file ) {
	...
	if ( file_exists( $ppath . $file ) ) {
		...
		_e( '<br />Missing File: ' . $ppath, $file . ' <br />', 'wp-stop-spammer' );
	}
	sfs_errorsonoff( 'off' );
}
