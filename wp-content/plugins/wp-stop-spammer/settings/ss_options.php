...
if ( !empty( $nonce ) && wp_verify_nonce( $nonce, 'ss_stopspam_update' ) ) {
	...
	$msg = '<div class="notice notice-success is-dismissible"><p>' . __( 'Options Updated', 'wp-stop-spammer' ) . '</p></div>';
}
...
<!-- <sup class="ss_sup"><?php _e( 'NEW!', 'wp-stop-spammer' ); ?></sup> -->
<div id="ss-plugin" class="wrap">
	<h1 class="ss_head">Stop Spammers — <?php _e( 'Protection Options', 'wp-stop-spammer' ); ?></h1>
	<br />
	<?php if ( !empty( $msg ) ) {
		echo $msg;
	} ?>
	...
	<form method="post" action="" name="ss">
		...
		<div id="formchecking" class="mainsection"><?php _e( 'Form Checking', 'wp-stop-spammer' ); ?>
		...
		<?php if ( is_plugin_active( 'woocommerce/woocommerce.php' ) ) {
			_e( '<p><span style="color:purple">WooCommerce detected. We recommend keeping this option enabled to avoid blocking customers.</span></p>', 'wp-stop-spammer' );
		} ?>
		<div class="checkbox switcher">
			<label id="ss_subhead" for="chkform">
				...
				<small><span style="font-size:16px!important"><?php _e( 'Only Use the Plugin for Standard WordPress Forms', 'wp-stop-spammer' ); ?></span></small>
			</label>
		</div>
		<br />
		<div id="membersonly" class="mainsection"><?php _e( 'Members-only Mode', 'wp-stop-spammer' ); ?>
		...
		<div class="checkbox switcher">
			<label id="ss_subhead" for="ss_private_mode">
				...
				<small><span style="font-size:16px!important"><?php _e( 'Require Users to Be Logged in to View Site', 'wp-stop-spammer' ); ?></span></small>
			</label>
		</div>
		<br />
		<div id="preventlockouts" class="mainsection"><?php _e( 'Prevent Lockouts', 'wp-stop-spammer' ); ?>
		...
		<div class="checkbox switcher">
			<label id="ss_subhead" for="addtoallowlist">
				...
				<small><span style="font-size:16px!important"><?php _e( 'Automatically Add Admins to Allow List', 'wp-stop-spammer' ); ?></span></small>
			</label>
		</div>
		<br />
		<div class="checkbox switcher">
			<label id="ss_subhead" for="chkadminlog">
				...
				<small><span style="font-size:16px!important"><?php _e( 'Check Credentials on All Login Attempts', 'wp-stop-spammer' ); ?></span></small>
			</label>
		</div>
		
		<br />
		<div id="notificationcontrol" class="mainsection">
			<?php _e( 'Notification Control', 'wp-stop-spammer' ); ?>
		...
		<?php if ( is_plugin_active( 'stop-spammers-premium/stop-spammers-premium.php' ) ) {
			_e( '<p>Find the full Notification Control options on the <a href="admin.php?page=ssp_premium">Premium Features page</a>.</p>', 'wp-stop-spammer' );
		} else {
			_e( '<p>This feature is extended in <a href="https://stopspammers.io/updates/notification-control-stop-admin-spam-messages/" target="_blank">Stop Spammers Premium</a>.</p>', 'wp-stop-spammer' );
		} ?>
		<div class="checkbox switcher">
			<label id="ss_subhead" for="ss_keep_hidden_btn">
				...
				<small><span style="font-size:16px!important"><?php _e( 'Show Keep Hidden Button', 'wp-stop-spammer' ); ?></span></small>
			</label>
		</div>
		<br />
		<div class="checkbox switcher">
			<label id="ss_subhead" for="ss_hide_all_btn">
				...
				<small><span style="font-size:16px!important"><?php _e( 'Show Hide All Notices Button', 'wp-stop-spammer' ); ?></span></small>
			</label>
		</div>
		<br />
		<div id="validaterequests" class="mainsection"><?php _e( 'Validate Requests', 'wp-stop-spammer' ); ?>
		...
		<div class="checkbox switcher">
			<label id="ss_subhead" for="chkaccept">
				...
				<small><span style="font-size:16px!important"><?php _e( 'Block Spam Missing the HTTP_ACCEPT Header', 'wp-stop-spammer' ); ?></span></small>
			</label>
		</div>
		<br />
		<div class="checkbox switcher">
			<label id="ss_subhead" for="chkreferer">
				...
				<small><span style="font-size:16px!important"><?php _e( 'Block Invalid HTTP_REFERER', 'wp-stop-spammer' ); ?></span></small>
			</label>
		</div>
		<br />
		<div class="checkbox switcher">
			<label id="ss_subhead" for="chkdisp">
				...
				<small><span style="font-size:16px!important"><?php _e( 'Block Disposable Email Addresses', 'wp-stop-spammer' ); ?></span></small>
			</label>
		</div>
		<br />
		<div class="checkbox switcher">
			<label id="ss_subhead" for="chklong">
				...
				<small><span style="font-size:16px!important"><?php _e( 'Check for Long Emails, Author Name, or Password', 'wp-stop-spammer' ); ?></span></small>
			</label>
		</div>
		<br />
		<div class="checkbox switcher">
			<label id="ss_subhead" for="chkshort">
				...
				<small><span style="font-size:16px!important"><?php _e( 'Check for Short Emails or Author Name', 'wp-stop-spammer' ); ?></span></small>
			</label>
		</div>
		<br />
		<div class="checkbox switcher">
			<label id="ss_subhead" for="chkbbcode">
				...
				<small><span style="font-size:16px!important"><?php _e( 'Check for BBCodes', 'wp-stop-spammer' ); ?></span></small>
			</label>
		</div>
		<br />
		<div class="checkbox switcher">
			<label id="ss_subhead" for="chkperiods">
				...
				<small><span style="font-size:16px!important"><?php _e( 'Check for Periods', 'wp-stop-spammer' ); ?></span></small>
			</label>
		</div>
		<br />
		<div class="checkbox switcher">
			<label id="ss_subhead" for="chkhyphens">
				...
				<small><span style="font-size:16px!important"><?php _e( 'Check for Hyphens', 'wp-stop-spammer' ); ?></span></small>
			</label>
		</div>
		<br />
		<div class="checkbox switcher">
			<label id="ss_subhead" for="chksession">
				...
				<small><span style="font-size:16px!important"><?php _e( 'Check for Quick Responses', 'wp-stop-spammer' ); ?></span></small>
			</label>
		</div>
		<br />
		<span id="ss_show_quick" style="margin-left:30px;margin-bottom:15px;display:none">
			<p style="margin-left:30px"><?php _e( 'Response Timeout Value: ', 'wp-stop-spammer' ); ?>
			<input name="sesstime" type="text" value="<?php echo $sesstime; ?>" size="2"/><br /></p>
		</span>
		<script>
		...
		<div class="checkbox switcher">
			<label id="ss_subhead" for="chk404">
				...
				<small><span style="font-size:16px!important"><?php _e( 'Block 404 Exploit Probing', 'wp-stop-spammer' ); ?></span></small>
			</label>
		</div>
		<br />
		<div class="checkbox switcher">
			<label id="ss_subhead" for="chkakismet">
				...
				<small><span style="font-size:16px!important"><?php _e( 'Block IPs Detected by Akismet', 'wp-stop-spammer' ); ?></span></small>
			</label>
		</div>
		<br />
		<div class="checkbox switcher">
			<label id="ss_subhead" for="chkexploits">
				...
				<small><span style="font-size:16px!important"><?php _e( 'Check for Exploits', 'wp-stop-spammer' ); ?></span></small>
			</label>
		</div>
		<br />
		<div class="checkbox switcher">
			<label id="ss_subhead" for="chkadmin">
				...
				<small><span style="font-size:16px!important"><?php _e( 'Block Login Attempts Using "admin" in Username', 'wp-stop-spammer' ); ?></span></small>
			</label>
		</div>
		<br />
		<div class="checkbox switcher">
			<label id="ss_subhead" for="chkubiquity">
				...
				<small><span style="font-size:16px!important"><?php _e( 'Check Against List of Ubiquity-Nobis and Other Spam Server IPs', 'wp-stop-spammer' ); ?></span></small>
			</label>
		</div>
		<br />
		<div class="checkbox switcher">
			<label id="ss_subhead" for="chkhosting">
				...
				<small><span style="font-size:16px!important"><?php _e( 'Check for Major Hosting Companies and Cloud Services', 'wp-stop-spammer' ); ?></span></small>
			</label>
		</div>
		<br />
		<div class="checkbox switcher">
			<label id="ss_subhead" for="chktor">
				...
				<small><span style="font-size:16px!important"><?php _e( 'Check for Tor Exit Nodes', 'wp-stop-spammer' ); ?></span></small>
			</label>
		</div>
		<br />
		<div class="checkbox switcher">
			<label id="ss_subhead" for="chkmulti">
				...
				<small><span style="font-size:16px!important"><?php _e( 'Check for Many Hits in a Short Time', 'wp-stop-spammer' ); ?></span></small>
			</label>
		</div>
		<span id="ss_show_chkmulti" style="margin-left:30px;margin-bottom:15px;display:none">
			<p style="margin-left:30px"><?php _e( 'Block access when there are', 'wp-stop-spammer' ); ?>
				...
				<?php _e( 'comments or logins in less than', 'wp-stop-spammer' ); ?>
				...
				<?php _e( 'minutes.', 'wp-stop-spammer' ); ?><br />
			</p>
		</span>
		<script>
		...
		<div class="checkbox switcher">
			<label id="ss_subhead" for="chkamazon">
				...
				<small><span style="font-size:16px!important"><?php _e( 'Check for Amazon Cloud', 'wp-stop-spammer' ); ?></span></small>
			</label>
		</div>
		<br />
		<div class="checkbox switcher">
			<label id="ss_subhead" for="filterregistrations">
				...
				<small><span style="font-size:16px!important"><?php _e( 'Filter Login Requests', 'wp-stop-spammer' ); ?></span></small>
			</label>
		</div>
		<br />
		<div id="blockcountries" class="mainsection"><?php _e( 'Block Countries', 'wp-stop-spammer' ); ?>
		...
		<div class="checkbox switcher">
			<label id="ss_subhead" for="countries">
				...
				<small><span class="button-primary" style="font-size:16px!important"><?php _e( 'Check All', 'wp-stop-spammer' ); ?></span></small>
			</label>
		</div>
		<br />
		<div class="stat-box">
		...
		<br style="clear:both" />
		<p class="submit"><input class="button-primary" value="<?php _e( 'Save Changes', 'wp-stop-spammer' ); ?>" type="submit" /></p>
	</form>
</div>
